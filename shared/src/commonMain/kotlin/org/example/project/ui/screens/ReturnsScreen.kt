...
class ReturnsScreen: Screen {
    ...
    override fun Content() {
        var showNewReturnDialog by rememberSaveable { mutableStateOf(false) }
        ...
        ScreenContainer {
            Column(
                ...
                GenericHeaderWithButtonAndSearch(
                    title = "Devoluciones",
                    description = "Listado de todas las devoluciones históricas",
...
@Composable
private fun AddNewReturnDialog(onDismiss: () -> Unit) {
